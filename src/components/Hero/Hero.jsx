    ...
    <div className='container mx-auto px-5 pt-8'>
        <div className='grid grid-cols-1 md:grid-cols-2 md:gap-10 font-[poppins]'>
            <div className='flex flex-col items-center justify-center md:items-start'>
                <h1 className='text-4xl font-bold pb-10 md:text-5xl text-center md:text-start'>
                ...
                <p className='font-[poppins] font-medium text-xl md:text-2xl pb-10 text-center md:text-start'>
                ...
                <div className='flex justify-center items-center md:justify-start gap-8 py-10 text-xl md:text-2xl font-[poppins] font-medium'>
                    <div>
                        <p>300+</p>
                        <p>Yoga Class</p>
                    </div>
            ...
            <div>
                <img src={girlHero} alt="" className='md:h-[100vh] md:w-full'/>
            </div>
        </div>
    </div>
  );
